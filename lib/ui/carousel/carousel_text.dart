...
RichText slide1Text = RichText(
  text: const TextSpan(
    children: <TextSpan>[
      ...
      TextSpan(text: 'campaign', style: carouselBlueTextStyle)
    ],
  ),
...
RichText slide2Text = RichText(
  text: const TextSpan(
    children: <TextSpan>[
      TextSpan(text: 'Efficiently', style: carouselWhiteTextStyle),
      TextSpan(text: ' target customers', style: carouselBlueTextStyle),
    ],
  ),
  textAlign: TextAlign.center,
);
